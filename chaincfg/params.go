...
var (
	...
	mainPowLimit, _ = new(big.Int).SetString("00000fffff000000000000000000000000000000000000000000000000000000", 16)
...
var MainNetParams = Params{
	...
	// Checkpoints ordered from oldest to newest.
	Checkpoints: []Checkpoint{
		{100000, newHashFromStr("000000000400a93131a94ad193c63faafeb8dfcc0c7d0e6f1c9c2614cb2823eb")},
		{200000, newHashFromStr("000000000010dd127bfe9f6b8c36080c45bcd352151aa0d2a4c79c9eba1e05b6")},
		{300000, newHashFromStr("00000001eeb1cbdf539452ad9ae38c3c7bb481a246dc7464d22bf6272be0bc85")},
		{400000, newHashFromStr("0000000001d45af6613024ad5668bfa4909ac63e2b29c28042013d77a216830d")},
		{500000, newHashFromStr("0000000003700a4e9d81a67036d7647361086527e985cdf764648c5e61d07303")},
		{2300000, newHashFromStr("e4334379b84be2ac4b2118a15323cb414bedf26a1dfce2c591b33e6dca643b92")},
		{2700000, newHashFromStr("49fa4075fa2396bf797818e172b3b5702a39d8318606a0ee01c5d06555e65bf6")},
		{3700001, newHashFromStr("65a6844e9cee118fd45edb78e36ed81eee149a16ccec7d859951a28ef6604cfe")}, //v6 fork
	},
	...
	Deployments: [DefinedDeployments]ConsensusDeployment{
		...
		DeploymentCSV: {
			BitNumber:  0,
			StartTime:  1529247969, // May 1st, 2016
			ExpireTime: 1559347200, // May 1st, 2017
		},
		DeploymentSegwit: {
			BitNumber:  1,
			StartTime:  1529247969, // November 15, 2016 UTC
			ExpireTime: 1559347200, // November 15, 2017 UTC.
		},
	},
