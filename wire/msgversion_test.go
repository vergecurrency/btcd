...
func TestVersion(t *testing.T) {
	...
	tcpAddrMe := &net.TCPAddr{IP: net.ParseIP("127.0.0.1"), Port: 21102}
	me := NewNetAddress(tcpAddrMe, SFNodeNetwork)
	tcpAddrYou := &net.TCPAddr{IP: net.ParseIP("192.168.0.1"), Port: 21102}
...
var baseVersionEncoded = []byte{
	...
	0x20, 0x8d, // Port 21102 in big-endian
