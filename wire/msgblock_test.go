...
func TestBlockHash(t *testing.T) {
	// Block 1 hash.
	hashStr := "7342680f4a3d7a3d34a9214b5b71c6f1bec3d633d6d2b84d474a6be55fd"
	wantHash, err := chainhash.NewHashFromStr(hashStr)
	if err != nil {
		t.Errorf("NewHashFromStr: %v", err)
	}
...
var blockOne = MsgBlock{
	Header: BlockHeader{
		...
		PrevBlock: chainhash.Hash([chainhash.HashSize]byte{ // Make go vet happy.
			0x78, 0x72, 0xd7, 0x90, 0xc7, 0x4c, 0x30, 0x63,
			0x14, 0x00, 0xa1, 0xdf, 0x5b, 0xd7, 0x01, 0xc6,
		...
		MerkleRoot: chainhash.Hash([chainhash.HashSize]byte{ // Make go vet happy.
			0xef, 0xa9, 0x59, 0x60, 0x21, 0xe9, 0xab, 0x13,
			0x89, 0x9b, 0xf0, 0x39, 0x14, 0x85, 0x3d, 0x73,
			0xd5, 0x5d, 0x3c, 0xbd, 0x97, 0x35, 0x25, 0x02,
			0xd2, 0x3f, 0x5b, 0x01, 0x98, 0xac, 0x18, 0x54,
		}),

		Timestamp: time.Unix(0x5436DC4F, 0),
		Bits:      0x1e0fffff,
		Nonce:     23765,
	},
	Transactions: []*MsgTx{
			...
			TxOut: []*TxOut{
				{
					...
					PkScript: []byte{
						...
						0xa2, 0x9d, 0x22, 0x60, 0xb0, 0xc3, 0xc4, 0x77, 0x82, 0xd9,
						0x21, 0x04, 0x4c, 0xbb, 0xac,
					},
				},
			},
			Time:     0x5436DC43,
...
var blockOneBytes = []byte{
	...
	0x14, 0x00, 0xa1, 0xdf, 0x5b, 0xd7, 0x01, 0xc6,
	0x0d, 0x20, 0x53, 0x3b, 0xdb, 0x0c, 0xb2, 0xae,
	0x7f, 0x46, 0x92, 0x36, 0xc6, 0x0f, 0x00, 0x00, // PrevBlock
	0xef, 0xa9, 0x59, 0x60, 0x21, 0xe9, 0xab, 0x13,
	0x89, 0x9b, 0xf0, 0x39, 0x14, 0x85, 0x3d, 0x73,
	0xd5, 0x5d, 0x3c, 0xbd, 0x97, 0x35, 0x25, 0x02,
	0xd2, 0x3f, 0x5b, 0x01, 0x98, 0xac, 0x18, 0x54, // MerkleRoot
	0x4F, 0xDC, 0x36, 0x54, // Timestamp
	0xff, 0xff, 0x0f, 0x1e, // Bits
	0xd5, 0x5c, 0x00, 0x00, // Nonce
	0x01,                   // TxnCount
	0x01, 0x00, 0x00, 0x00, // Version
	0x43, 0xdc, 0x36, 0x54, // tx time
	...
	0x00, 0xd0, 0xed, 0x90, 0x2e, 0x00, 0x00, 0x00, // Transaction amount
	0x23, // varint size of signature
	0x21, 0x02, 0x43, 0x87, 0x54, 0x5a, 0xeb, 0xf2,
	0xf1, 0x9a, 0x15, 0x4a, 0x05, 0x84, 0x51, 0x81,
	0x94, 0x46, 0x2e, 0x8b, 0xa2, 0x9d, 0x22, 0x60,
	0xb0, 0xc3, 0xc4, 0x77, 0x82, 0xd9, 0x21, 0x04,
	0x4c, 0xbb, // 65 byte pubkey
	0xac,                   // CHECKSIGOutputSignature
	0x00, 0x00, 0x00, 0x00, // Lock time
	0x00, // varint block sig size

}

// Transaction location information for block one transactions.
var blockOneTxLocs = []TxLoc{
	{TxStart: 81, TxLen: 109},
}
