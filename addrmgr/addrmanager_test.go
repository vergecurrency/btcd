...
func addNaTests() {
	...
	// IPv6
	// Localhost
	addNaTest("::1", 21102, "[::1]:21102")
	addNaTest("fe80::1", 8334, "[fe80::1]:8334")

	// Link-local
	addNaTest("fe80::1:1", 21102, "[fe80::1:1]:21102")
	addNaTest("fe91::2:2", 8334, "[fe91::2:2]:8334")
	addNaTest("fea2::3:3", 8335, "[fea2::3:3]:8335")
	addNaTest("feb3::4:4", 8336, "[feb3::4:4]:8336")

	// Site-local
	addNaTest("fec0::1:1", 21102, "[fec0::1:1]:21102")
...
func TestAttempt(t *testing.T) {
	...
	err := n.AddAddressByIP(someIP + ":21102")
	if err != nil {
...
func TestNeedMoreAddresses(t *testing.T) {
	...
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.%d.173.147:21102", i/128+60, i%128+60)
	...
	srcAddr := wire.NewNetAddressIPPort(net.IPv4(173, 144, 173, 111), 21102, 0)
...
func TestGood(t *testing.T) {
	...
	var err error
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.173.147.%d:21102", i/64+60, i%64+60)
		addrs[i], err = n.DeserializeNetAddress(s, wire.SFNodeNetwork)
		if err != nil {
			t.Errorf("Failed to turn %s into an address: %v", s, err)
		}
