...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vergecurrency/btcd/mempool)
...
```bash
$ go get -u github.com/vergecurrency/btcd/mempool
```
